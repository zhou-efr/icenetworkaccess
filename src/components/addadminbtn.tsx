    ...
    return (
        <>
            ...
            <button
                ...
                className="block rounded-md bg-ice-efrei-dark-blue px-3 py-2 text-center text-sm font-semibold text-white hover:bg-ice-efrei-blue focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ice-efrei-blue"
                >
                Add admin
            </button>
                ...
                <div className="fixed inset-0 overflow-hidden">
                    ...
                    <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10 sm:pl-16">
                        ...
                        <form 
                            ...
                            className="flex h-full flex-col divide-y divide-gray-300 bg-white shadow-xl"
                            >
                            <div className="h-0 flex-1 overflow-y-auto">
                            <div className="px-4 py-6 sm:px-6">
                                <div className="flex items-center justify-between">
                                <DialogTitle className="text-base font-semibold text-gray-900">Ajouter un administrateur</DialogTitle>
                            ...
                            <div className="flex flex-1 flex-col justify-between">
                                <div className="divide-y divide-gray-300 px-4 sm:px-6">
                                    <div className="space-y-6 pb-5 pt-6">
                                        <div>
                                        <label htmlFor="usermail" className="block text-sm/6 font-medium text-gray-900">
                                        ...
                                        <div className="mt-2">
                                            ...
                                            value={newAdminMail}
                                            className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-900 sm:text-sm/6"
                                            />
                                        </div>
                                        </div>
                                    </div>
