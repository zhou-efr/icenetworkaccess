                                ...
                                <div className="divide-y divide-gray-200 px-4 sm:px-6">
                                    <div className="space-y-6 pb-5 pt-6">
                                        <div>
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="description" className="block text-sm font-medium font-semibold text-white">
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="serverpublic" className="block text-sm font-medium font-semibold text-white">
                                                        Server Public Key
                                                    </label>
                                                    <div className="mt-2">
                                                        <input
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="preshared" className="block text-sm font-medium font-semibold text-white">
                                                        Pre-shared Key
                                                    </label>
                                                    <div className="mt-2">
                                                        <input
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="userpublic" className="block text-sm font-medium font-semibold text-white">
                                                        User Public Key
                                                    </label>
                                                    <div className="mt-2">
                                                        <input
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="userprivate" className="block text-sm font-medium font-semibold text-white">
                                                        User Private Key
                                                    </label>
                                                    <div className="mt-2">
                                                        <input
                                            ...
                                            <div className="space-y-6 pb-5 pt-6">
                                                <div>
                                                    <label htmlFor="userip" className="block text-sm font-medium font-semibold text-white">
                                                        User IP Address
                                                    </label>
                                                    <div className="mt-2">
                                                        <input
